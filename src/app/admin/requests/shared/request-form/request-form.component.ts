...
export class RequestFormComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.form = new FormGroup({
      first_name: new FormControl(
        !this.request ? null : this.request.first_name,
        [Validators.required]
      ),
      last_name: new FormControl(
        this.request === null ? null : this.request.last_name,
        [Validators.required]
      ),
      age: new FormControl(this.request === null ? null : this.request.age),
      zone: new FormControl(this.request === null ? null : this.request.zone, [
        Validators.required,
      ]),
      address: new FormControl(
        this.request === null ? null : this.request.address,
        [Validators.required]
      ),
      apartment: new FormControl(this.request === null ? null : '?'),
      entrance: new FormControl(this.request === null ? null : '?'),
      floor: new FormControl(this.request === null ? null : '?'),
      phone: new FormControl(
        this.request === null ? null : this.request.phone,
        [
          Validators.required,
      ...
      landline: new FormControl(this.request === null ? null : '0', [
        Validators.required,
        Validators.minLength(6),
        Validators.maxLength(6),
        Validators.pattern(/^([0-9]){6}$/),
      ]),
      special_condition: new FormControl(this.request === null ? null : '?', [
        Validators.required,
      ]),
      ilness: new FormControl(
        this.request === null ? null : this.request.has_symptoms,
        [Validators.required]
      ),
      need: new FormControl(this.request === null ? '' : this.request.type, [
        Validators.required,
      ]),
      comments: new FormControl(
        this.request === null ? '' : this.request.comments
      ),
      password: new FormControl(
        this.request === null ? null : this.request.secret,
        [Validators.required, Validators.minLength(5), Validators.maxLength(5)]
      ),
      urgent: new FormControl(
        this.request === null ? false : this.request.is_urgent
      ),
    });
  }
  ngOnDestroy() {}
  ...
  checkForExistentBeneficiary(phone: any) {
    ...
    if (phone.length === 8 && this.request === null)
